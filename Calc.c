...
static long (*functions[]) (long, long) =
        { NULL, NULL, NULL, NULL, add, sub, mult, divide, 
                                exponent, NULL, fact };
...
ostream & operator << (ostream & stream, const Calculator & calculator) {
        ...
        calculator.stack1.Write (stream << "Stack 1 is:\n");
        calculator.stack2.Write (stream << "Stack 2 is:\n");
        return calculator.symtab.Write (stream << "Symbol Table is:\n");
}
